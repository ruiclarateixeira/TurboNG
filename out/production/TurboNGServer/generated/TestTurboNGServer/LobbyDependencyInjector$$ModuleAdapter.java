...
public final class LobbyDependencyInjector$$ModuleAdapter extends ModuleAdapter<LobbyDependencyInjector> {
  ...
  public LobbyDependencyInjector$$ModuleAdapter() {
    super(TestTurboNGServer.LobbyDependencyInjector.class, INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, true /*complete*/, false /*library*/);
  }

  @Override
  public LobbyDependencyInjector newModule() {
    return new TestTurboNGServer.LobbyDependencyInjector();
  }
  ...
  public void getBindings(BindingsGroup bindings, LobbyDependencyInjector module) {
    bindings.contributeProvidesBinding("TurboNGServer.Interface.LobbyInterface", new ProvideLIProvidesAdapter(module));
  ...
  /**
   * A {@code Binding<TurboNGServer.Interface.LobbyInterface>} implementation which satisfies
   * Dagger's infrastructure requirements including:
   *
   * Being a {@code Provider<TurboNGServer.Interface.LobbyInterface>} and handling creation and
   * preparation of object instances.
   */
  public static final class ProvideLIProvidesAdapter extends ProvidesBinding<TurboNGServer.Interface.LobbyInterface>
      implements Provider<TurboNGServer.Interface.LobbyInterface> {
    private final LobbyDependencyInjector module;

    public ProvideLIProvidesAdapter(LobbyDependencyInjector module) {
      super("TurboNGServer.Interface.LobbyInterface", NOT_SINGLETON, "TestTurboNGServer.LobbyDependencyInjector", "provideLI");
      this.module = module;
      setLibrary(false);
    }
     ...
     * {@code Provider<TurboNGServer.Interface.LobbyInterface>}.
     */
    @Override
    public TurboNGServer.Interface.LobbyInterface get() {
      return module.provideLI();
    }
  }
  ...
  public static final class ProvideUserProvidesAdapter extends ProvidesBinding<TurboNGServer.Lobby.Player>
    ...
    public ProvideUserProvidesAdapter(LobbyDependencyInjector module) {
      super("TurboNGServer.Lobby.Player", NOT_SINGLETON, "TestTurboNGServer.LobbyDependencyInjector", "provideUser");
      this.module = module;
      setLibrary(false);
    }
  ...
  public static final class ProvideNewsFeedProvidesAdapter extends ProvidesBinding<TurboNGServer.Lobby.NewsFeed>
    ...
    public ProvideNewsFeedProvidesAdapter(LobbyDependencyInjector module) {
      super("TurboNGServer.Lobby.NewsFeed", NOT_SINGLETON, "TestTurboNGServer.LobbyDependencyInjector", "provideNewsFeed");
      this.module = module;
      setLibrary(false);
    }
