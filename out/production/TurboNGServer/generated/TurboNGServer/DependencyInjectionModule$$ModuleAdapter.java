...
public final class DependencyInjectionModule$$ModuleAdapter extends ModuleAdapter<DependencyInjectionModule> {
  ...
  public DependencyInjectionModule$$ModuleAdapter() {
    super(TurboNGServer.DependencyInjectionModule.class, INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, true /*complete*/, false /*library*/);
  }

  @Override
  public DependencyInjectionModule newModule() {
    return new TurboNGServer.DependencyInjectionModule();
  }
   ...
   */
  public static final class ProvideUserProvidesAdapter extends ProvidesBinding<Lobby.User>
      implements Provider<Lobby.User> {
    private final DependencyInjectionModule module;

    public ProvideUserProvidesAdapter(DependencyInjectionModule module) {
      super("TurboNGServer.Lobby.User", NOT_SINGLETON, "TurboNGServer.DependencyInjectionModule", "provideUser");
      this.module = module;
      setLibrary(false);
    }
